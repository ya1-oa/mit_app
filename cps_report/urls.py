...
urlpatterns = [
    ...
    path('session/<int:session_id>/export-evaluation/', views.export_evaluation_excel, name='cps_report_export_evaluation'),
    ...
    path('session/<int:session_id>/archive/', views.api_archive_session, name='cps_archive_session'),
    ...
    path('api/delete-photo/', views.api_delete_photo, name='cps_api_delete_photo'),

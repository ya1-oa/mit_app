        ...
        for col_idx in range(FIRST_DATA_COLUMN, len(df.columns)):
            ...
            try:
                ...
                mapped_data = {
                    ...
                    'roomArea1': client_data.get('roomarea_1', ''),
                    'roomArea2': client_data.get('roomarea_2', ''),
                    'roomArea3': client_data.get('roomarea_3', ''),
                    'roomArea4': client_data.get('roomarea_4', ''),
                    'roomArea5': client_data.get('roomarea_5', ''),
                    'roomArea6': client_data.get('roomarea_6', ''),
                    'roomArea7': client_data.get('roomarea_7', ''),
                    'roomArea8': client_data.get('roomarea_8', ''),
                    'roomArea9': client_data.get('roomarea_9', ''),
                    'roomArea10': client_data.get('roomarea_10', ''),
                    'roomArea11': client_data.get('roomarea_11', ''),
                    'roomArea12': client_data.get('roomarea_12', ''),
                    'roomArea13': client_data.get('roomarea_13', ''),
                    'roomArea14': client_data.get('roomarea_14', ''),
                    'roomArea15': client_data.get('roomarea_15', ''),
                    'roomArea16': client_data.get('roomarea_16', ''),
                    'roomArea17': client_data.get('roomarea_17', ''),
                    'roomArea18': client_data.get('roomarea_18', ''),
                    'roomArea19': client_data.get('roomarea_19', ''),
                    'roomArea20': client_data.get('roomarea_20', ''),
                    'roomArea21': client_data.get('roomarea_21', ''),
                    'roomArea22': client_data.get('roomarea_22', ''),
                    'roomArea23': client_data.get('roomarea_23', ''),
                    'roomArea24': client_data.get('roomarea_24', ''),
                    'roomArea25': client_data.get('roomarea_25', ''),

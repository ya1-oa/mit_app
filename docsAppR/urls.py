...
urlpatterns = [
    ...
    path('claims/<int:claim_id>/push-rooms-to-encircle/', claims_views.push_rooms_to_encircle, name='push_rooms_to_encircle'),
    path('claims/<int:claim_id>/preview-rooms/', claims_views.preview_rooms_entries, name='preview_rooms_entries'),
    path('claims/push-rooms/', claims_views.push_rooms_page, name='push_rooms_page'),
    path('claims/migrate-encircle-rooms/', claims_views.migrate_encircle_rooms, name='migrate_encircle_rooms'),
    path('claims/duplicate-encircle-claim/', claims_views.duplicate_encircle_claim, name='duplicate_encircle_claim'),
    path('claims/pushed-rooms/', claims_views.get_pushed_rooms, name='get_pushed_rooms'),
    path('claims/delete-pushed-rooms/', claims_views.delete_pushed_rooms, name='delete_pushed_rooms'),
    ...
    path('labels/email-to-group/', views.email_labels_to_group, name='email_labels_to_group'),
    path('wall-labels/', views.wall_labels, name='wall_labels'),
    path('wall-labels/<str:claim_id>/download-all/', views.generate_wall_labels_download, name='generate_wall_labels_download'),
    ...
    path('api/encircle/claims/simple/', claims_views.encircle_claims_simple, name='encircle_claims_simple'),
    ...
    path('claim-images/download/', views.claim_media_downloader_view, name='claim_media_downloader'),

...
urlpatterns = [
    ...
    path('claims/send-room-list/', claims_views.send_room_list_from_claim, name='send_room_list_from_claim'),
    path('claims/task-status/', claims_views.claim_task_status, name='claim_task_status'),
    path('claims/<int:claim_id>/push-to-encircle/', claims_views.push_to_encircle, name='push_to_encircle'),
    ...
    path('labels/<str:claim_id>/download-all/', views.generate_combined_labels, name='generate_combined_labels'),
